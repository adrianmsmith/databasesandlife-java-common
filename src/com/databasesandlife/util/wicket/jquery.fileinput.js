...
$.fn.customFileInput = function(){
	...
	var uploadButton = $('<span class="customfile-button" aria-hidden="true">Bild hochladen</span>').appendTo(upload);
	//create custom control feedback
	var uploadFeedback = $('<span class="customfile-feedback" aria-hidden="true">Keine Datei spezifiziert</span>').appendTo(upload);
